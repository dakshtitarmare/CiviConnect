...
const AdminDashboard = () => {
    ...
    }, []); // Removed mockIssues from dependency array as it's constant
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50/30 to-emerald-50/20 dark:from-gray-900 dark:via-gray-800/30 dark:to-gray-900/20">
            ...
            <aside
                className={`fixed top-0 left-0 h-full z-50 transition-all duration-300 ease-in-out bg-white/80 backdrop-blur-xl border-r border-gray-200/50 dark:bg-gray-900/80 dark:border-gray-700/50 flex flex-col shadow-xl ${isSidebarOpen ? 'w-64' : 'w-16' // Corrected width
                    }`}
            >
            ...
            {/* Main content needs to be offset by the sidebar width */}
            <div className={`transition-all duration-300 ease-in-out ${isSidebarOpen ? 'pl-64' : 'pl-16'}`}>
                <motion.header
                    className="bg-white/80 backdrop-blur-md border-b border-green-100 dark:bg-gray-900/80 dark:border-gray-700 sticky top-0 z-30" // Lowered z-index
                    initial={{ opacity: 0, y: -20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6 }}
                >
                    {/* Removed max-w-7xl mx-auto to allow full width header */}
                    <div className="px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between items-center py-4">
                            {/* This div is a spacer to align with sidebar toggle, or you can add breadcrumbs */}
                ...
                <motion.div
                    ...
                    animate="animate"
                >
                    {/* THIS IS THE AREA WHERE THE DUPLICATED CODE WAS.
                    It has been removed.
                    The content below is the CORRECT content for the dashboard.
                    */}
            ...
            </div> {/* This closes the main content wrapper (offset by sidebar) */}
