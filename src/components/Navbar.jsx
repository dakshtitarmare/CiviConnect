...
//                   )}
//                   <Icon
//                     className={`w-4 h-4 transition-transform duration-300 relative z-10 ${isActive ? 'scale-110' : 'group-hover:scale-110'
//                       }`}
//                   />
...
//                       )}
//                       <Icon
//                         className={`w-5 h-5 transition-transform duration-300 relative z-10 ${isActive ? 'scale-110' : 'group-hover:scale-110'
//                           }`}
//                       />
//                       <span className="relative z-10">{navItem.title}</span>
//                     </Link>
...
//                 <button
//                   onClick={() => handleNav(() => navigate('/login-admin'))}
...
//                 <button
//                   onClick={() => handleNav(() => navigate('/login-user'))}
//                   className="w-full flex items-center gap-4 px-6 py-4 text-base font-medium text-gray-700 dark:text-gray-300 border-2 border-green-200 dark:border-green-800 hover:border-green-400 dark:hover:border-green-600 hover:bg-green-50 dark:hover:bg-green-950/50 rounded-xl transition-all duration-300 group"
//                 >
//                   <User className="w-5 h-5 group-hover:scale-110 transition-transform duration-300" />
                ...
                <div className="absolute right-0 mt-2 w-64 rounded-2xl bg-white dark:bg-slate-900 shadow-2xl border border-green-100 dark:border-green-900/20 z-50 overflow-hidden">
                  <div className="p-2">
                    ...
                    {!(isSignedIn || token) ? (
                      <>
                        <button
                          onClick={() => { setRightDropdownOpen(false); navigate('/login-user'); }}
                          className="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-white bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 rounded-xl transition-all duration-200 group mt-2"
                        >
                          <User className="w-4 h-4 group-hover:scale-110 transition-transform duration-200" />
                          <span>Login as User</span>
                        ...
                        <button
                          onClick={() => { setRightDropdownOpen(false); navigate('/login-admin'); }}
                          className="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 hover:bg-green-50 dark:hover:bg-green-950/50 rounded-xl transition-all duration-200 group mt-2"
                        >
                          <Shield className="w-4 h-4 group-hover:scale-110 transition-transform duration-200" />
                          <span>Login as Admin</span>
                        </button>
          ...
          <div className="lg:hidden fixed inset-x-0 top-0 z-50">
            ...
            >
              ...
              <div className="space-y-3 flex-1">
                ...
                {/* === MODIFICATION: These buttons were moved inside the 'else' block below === */}
                ...
                {(isSignedIn || token) ? (
                  ...
                  <>
                    {/* === MODIFICATION START: Moved Admin/User login buttons here === */}
                    <button
                      onClick={() => handleNav(() => navigate('/login-admin'))}
                      className="w-full flex items-center gap-4 px-6 py-4 text-base font-medium text-gray-700 dark:text-gray-300 border-2 border-green-200 dark:border-green-800 hover:border-green-400 dark:hover:border-green-600 hover:bg-green-50 dark:hover:bg-green-950/50 rounded-xl transition-all duration-300 group"
                    >
