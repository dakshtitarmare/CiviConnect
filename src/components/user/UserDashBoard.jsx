...
import {
    ...
    Bell, X, MessageCircle, MapPin, Search, Calendar, Bus,
    ChartColumn, Vote, Building2, Car, Zap, HandCoins,
    ReceiptIndianRupee, TrainFront, School, Plane
} from "lucide-react";

/**
 * Reusable Dashboard Card Component
 * Moved outside UserDashboard for correct component definition.
 */
...
const UserDashboard = () => {
    ...
    const dashboardItems = [
        ...
        // ... all your other items would go here
    ];
    ...
    return (
        // Main wrapper div (removed the duplicate)
