...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      href: "https://github.com/HarshS16/CiviConnectonnect",
      icon: Github,
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/CiviConnectonnect",
      icon: Twitter,
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/company/CiviConnectonnect",
      icon: Linkedin,
    ...
    {
      name: "YouTube",
      href: "https://youtube.com/c/CiviConnectonnect",
      icon: Youtube,
  ...
  const footerLinks = [
    ...
    //       href: "/tutorials",
    //       icon: UsersIcon,
    //       description: "Learn how to use CiviConnect",
    //     },
    //   ],
    // },
    {
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-8 lg:gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a
                href="mailto:support@CiviConnect.com"
              ...
              >
                ...
                <span>support@CiviConnect.com</span>
              </a>
              <a
        ...
        <div className="text-center py-8 border-t border-slate-200/50 dark:border-slate-700/50">
          <div className="max-w-xl mx-auto space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-slate-600 dark:text-slate-300 text-sm">
                Your feedback helps us improve CiviConnect for everyone
              </p>
            </div>
        ...
        <div className="border-t border-slate-200/50 dark:border-slate-700/50 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-slate-500 dark:text-slate-400 text-xs flex items-center">
              © {currentYear} CiviConnect. All rights reserved.
