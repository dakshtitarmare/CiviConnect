...
const questions = [
  {
    ...
    answer: "Civix is a CiviConnectonnectonnectonnectonnectonnectonnectonnectonnectonnectonnectonnectonnect engagement platform that allows citizens to report and track local issues in their communities, such as potholes, broken streetlights, and garbage collection problems.",
    popular: true,
    icon: (
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <Helmet>
        ...
        <meta name="description" content="Civix helps citizens report and track local CiviConnectonnectonnectonnectonnectonnectonnectonnectonnectonnectonnectonnect issues like potholes, broken lights, and garbage collection problems. Make your city better today!" />
      </Helmet>
  ...
  <span className="bg-gradient-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">
    Make Your City Better.
          ...
          <p className="text-muted-foreground md:text-xl leading-relaxed">
            Civix helps citizens report and track local CiviConnectonnectonnectonnectonnectonnectonnectonnectonnectonnectonnectonnectonnect issues like potholes,
